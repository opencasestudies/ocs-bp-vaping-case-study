...
AVOCADO: What does the dense_rank function do? I guess something to order the panels by a summary of all the groups? I added a line to the paragraph above mentioning the ordering, but I'm not completely sure how it is done, in case you want to add another note.
AVOCADO: Why is the Neither group included? Shouldn't all these values be 0?
...
AVOCADO: Why is this section header here? I don't think it belongs here.
### Unweighted Sample
...
We do not need to calculate survey weights for our data as they were already supplied, as described in the codebooks. 
