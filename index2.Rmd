...
AVOCADO: I later learned that it is not correct that we need the same variables in the data set when using bind_rows, so why are we creating these dummy variables with NAs here? Won't they be automatically created later in any case? REMOVE CODE THAT ADDS THE NA VALUES
