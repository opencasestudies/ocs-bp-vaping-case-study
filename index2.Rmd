...
We are also interested in e-cigaratte usage compared to other tobacco products, so we will create some variables related to the sum of all e-cigarette usage questions and the sum of all tobacco usage questions besides those that ask about e-cigarettes.
