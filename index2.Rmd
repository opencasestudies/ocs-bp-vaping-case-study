...
The data in this survey is what is called pooled cross-sectional data. In other words, different subsets of students are surveyed each year and it is not clear which, if any , individuals participate from one year to the next.
...
Specific columns were selected from each of the tibbles using the variable name, as identified in the codebook for being of interest.
...
**ECIGAR** | student reported having ever tried cigar smoking, even one or two puffs
...
**CELCIGT** | student reported they have used electronic cigarettes or e-cigarettes (days??? CHECK non2019!)
**CROLLCIGTS** | student reported that have smoked roll-your-own cigarettes during the past 30 days
**CFLAVCIGTS**| (not in 2019)
**CBIDIS** |
...
**brand_ecig** | student answer to "During the past 30 days, what brand of e-cigarettes did
you usually use?"
**menthol** | student answered yes to "Menthol cigarettes are cigarettes that taste like mint.
During the past 30 days, were the cigarettes that you usually
smoked menthol?"
**clove_spice** | student selected clove or spice as the answer to "What flavors of tobacco products have you used in the past 30 days? (choose one or more)"
**fruit** | student selected fruit as the answer to "What flavors of tobacco products have you used in the past 30 days? (choose one or more)"
**chocolate** | student selected chocolate as the answer to "What flavors of tobacco products have you used in the past 30 days? (choose one or more)"
...
**candy_dessert_sweets** | student selected candy_dessert_sweets
...
We will sum across the ever or current tobacco usage questions to get determine if the student answered yes to any of the ever or current questions. If the sum is greater than zero, then we know the student answered yes to at least one question. 
 

```{r}
cw_nyts_data <-nyts_data %>%
