...
2. Merging data from multiple similar but not identical data structures
3. Creating effective longitudinal data visualizations
...
AVOCADO: I'm not sure where this should go, but I had the thought so I figured I'd include it. Maybe we can be more consistent about how we refer to students, subjects, respondents? Carrie suggests maybe trying to use students where we are talking about this specific data set, but respondents in the general survey weighting section. OK, I think it mostly says students or student respondents everywhere that we are referring to our specific data set. There are a couple places where we use subjects or respondents as general statistical terms. 
