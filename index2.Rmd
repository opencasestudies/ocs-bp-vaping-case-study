...
1) How has tobacco/nicotine and e-cigarette use by American youths changed since 2015?
...
I think we should remove this plot...
...
Should we remove this too and go with one of the earlier plots? plot1c?

Now we will take a look a students who reported trying or using e-cigarettes or non-e-cigarette products. In this case we will not separate out users who specifically only used one or the other. Therefore, the percentage of students included in this plot as being a current user of e-cigarettes might also be a current user of non-ecigarette products.
