...
We can get a first look at the answer by calculating the percent of females and percent of males: 
```{r}
nyts_data %>% 
...
* Odds ratio of e-cigarette use for males as compared to females: $$OR = \frac{odds \ for \ males}{odds \ for \ females} = \frac{1171 / 7787}{772 / 7850} = 1.53$$
...
summary(glm(ecig_current ~ Sex, data = dat2015))
...
$logit(p)= log(\frac{p}{1-p})= \beta_0 + \beta_1 X$, where $p=P(Y=1)=E(Y)$ 

where we define p as the probability that a student respondent is a current e-cigarette user, and Y is the binary variable that is 1 when a student respondent is a current e-cigarette user. 
