...
knitr::include_graphics("www/img/final_plot.png")
```
...
```{r, echo = FALSE, fig.align ="center"}
include_graphics("www/img/e-cigarette-aerosol-can-contain-harmful-ingredients.jpg")
```
...
knitr::include_graphics("www/img/lung.png")
```
...
knitr::include_graphics("www/img/data.png")
```
...
knitr::include_graphics("www/img/excel.png")
```

The codebook explains what the variables (the columns) are:
```{r, echo = FALSE, fig.align ="center", out.width = "600 px"}

knitr::include_graphics("www/img/variables.png")
```
...
knitr::include_graphics("www/img/qn1.png")
```
...
knitr::include_graphics("www/img/grade.png")
```
...
knitr::include_graphics("www/img/HuangJ_DuanZ_KwokJ_et_al_TobaccoControl_Figure1.png")
```
...
```{r, echo = FALSE, out.width = "800 px"}
knitr::include_graphics("www/img/plot2.png")
```
